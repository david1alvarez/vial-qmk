 ...
 * BASE -- QWERTY layer
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | Esc  |   1! |   2@ |   3# |   4$ |   5% |                    |   6^ |   7& |   8* |  9(  |  0)  |TOGAME|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[BASE] = LAYOUT_split_4x6_5(
    KC_ESC,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,     KC_7,     KC_8,    KC_9,    KC_0,     TO(GAME),
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_CAPS,   KC_MUTE,  KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH,  KC_BSLS,
                      KC_LCTL, KC_LALT, KC_LGUI, MO(SYM), KC_LSFT,   KC_SPC,   MO(EXT),  KC_RSFT,  KC_PGDN, KC_PGUP
),
 ...
 * |      |      |      |      |      |      |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /    \       \-----------------------------------------'
 *            | LCMD | LALT | LCTL | Space| /  MO   /      \       \  | Enter| TO   |      |      |
 *            |      |      |      |      |/  SYM  /        \       \ |      | GAME |      |      |
 *            '-----------------------------------'          '-------''---------------------------'
 */
 [GAME] = LAYOUT_split_4x6_5(
    ...
    _______,  _______,_______, _______, _______, _______, _______,  _______, _______,  _______, _______, _______, _______,  _______,
                      KC_LGUI, KC_LALT, KC_LCTL, KC_SPC,  MO(SYM),  KC_SPC,  KC_ENTER, _______, _______, _______
),
...
[SYM] = LAYOUT_split_4x6_5(
    ...
    _______, _______,    KC_QUOT,       KC_EQL,      KC_MINS,      _______,                         KC_LBRC,   LSFT(KC_LBRC),LSFT(KC_9), LSFT(KC_0),    _______, _______,
    _______, _______,    LSFT(KC_QUOT), LSFT(KC_EQL),LSFT(KC_MINS),_______,     PB_3,     _______,  KC_RBRC,   LSFT(KC_RBRC),KC_SCLN,    LSFT(KC_SCLN), _______, _______,
